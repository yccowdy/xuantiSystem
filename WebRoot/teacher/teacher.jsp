...
.gradient { /*   width:1680px;
	...
	filter: alpha(opacity =         60 finishopacity =         100 style =         1
		...
		150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=#235E98,
		endcolorstr=#DEEBF3, gradientType=0 );
	-ms-filter: alpha(opacity =  
	      60 finishopacity =         100 style =         1 startx =        
		0, starty =  
	      0, finishx =         0, finishy =         150) progid:  
	DXImageTransform.Microsoft.gradient(   startcolorstr=   #235E98,
	...
	background: -o-linear-gradient(top, rgba(35, 94, 152, 1),
		rgba(222, 235, 243, 0.6) );
	-ms-filter: alpha(opacity =         60 finishopacity =         100 style =         1
		startx =  
		      0, starty =         0, finishx =         0, finishy =        
		150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=#235E98,
		endcolorstr=#DEEBF3, gradientType=0 ); /*Opera11*/
}
//
-->
</style>
...
<span style="position: absolute; center:300px;top: 30px; font-size: 24px; font-weight: bolder; color: White; font-family: 楷体,楷体_GB2312;">
	...
	<!--  <table width="1092px" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			<td colspan="2" align="left"><div align="left"
					style="box-shadow:2px 1px 1px #C7EDCC;text-align:center;">
					<img src="images/myview.jpg" width="100%" height="100%" />
				</div>
			</td>
		</tr>
	</table>
	...
	<table width="100%" border="1" align="left" cellpadding="0"
		...
		<tr>
			<td colspan="2" height="30px"><div align="center">
					&nbsp;<%=tb.getName()%>老师，欢迎您使用计算机学院毕业选题系统
				</div>
				<div align="right">
					<a href="logout.jsp"
					    style="color:#000000;"
		...
		<tr>
			<td width="15%" height="600px" valign="top" bgcolor="#E1EEFB">
				<div align="left">
					...
					%>
					<jsp:include page="menu0.jsp"></jsp:include>
					<%
						}
					%>
				</div>
	...
	<table width="1092px" height="85" border="0" align="center"
		style="font-size: 12px">
		<tr bordercolor="#F0F0F0">
			<td>
				<div align="center" class="STYLE1">计算机学院：版权所有
					www.paperlayout.com 鄂ICP备1509号</div>
			</td>
		</tr>
	</table>
</body>
